...
def extraction_prompt(user_question: str) -> list:
    """
...
def extract_intent(client, user_question: str) -> dict:
    """
    ...
    """
    messages = extraction_prompt(user_question)
...
if __name__ == "__main__":
    ...
    for q in test_questions:
        print(f"Q: {q}")
        intent = extract_intent(client, q)
